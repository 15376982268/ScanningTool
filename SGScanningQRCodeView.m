...
//    [self.basedLayer addSublayer:scanContentView.layer];
    ...
    _animation_line.frame = CGRectMake(scanContent_X * 1.2, scanContentViewY, self.frame.size.width - (scanContent_X * 1.2 *2) , animation_line_H);
